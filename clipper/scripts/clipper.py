...
def cfg():
    ...
    return {
        ...
        "subtitle_word_highlight_enabled": parse_int(os.environ.get("SUBTITLE_WORD_HIGHLIGHT_ENABLED"), 1),
        "subtitle_emoji_popup_enabled": parse_int(os.environ.get("SUBTITLE_EMOJI_POPUP_ENABLED"), 1),
