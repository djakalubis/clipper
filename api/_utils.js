...
export function configSummary() {
  return {
    ...
    tiktokPrivacyLevel: clean(process.env.TIKTOK_PRIVACY_LEVEL || "PUBLIC_TO_EVERYONE"),
...
export function buildVideo(input) {
  ...
  return {
    ...
    theme: clean(input.theme || "ceramah"),
    ...
    ai_provider: "openai",
    scene_mode: clean(input.scene_mode || process.env.SCENE_MODE || "solo"),
